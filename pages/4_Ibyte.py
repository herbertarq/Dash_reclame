...
IBYTE = st.session_state['IBYTE']

# Unique values for filters
cidades = ['Todos'] + list(IBYTE['CIDADE'].unique())
estados = ['Todos'] + list(IBYTE['UF'].unique())
status_options = ['Todos'] + list(IBYTE['STATUS'].unique())
